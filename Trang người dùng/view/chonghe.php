...
<div class="choose-sits">
    <div class="choose-sits__info choose-sits__info--first">
        <ul>
            ...
            <li class="sits-price sits-price--cheap">100k</li>
            <li class="sits-price sits-price--middle">200k</li>
            <li class="sits-price sits-price--expensive">300k</li>
        </ul>
    </div>
    ...
    <div class="col-sm-12 col-lg-10 col-lg-offset-1">
        <div class="sits-area hidden-xs">
            ...
            <div class="sits">
                ...
                <div class="sits__row">
                    <span class="sits__place sits-price--cheap" data-place='A2' data-price='100'>A2</span>
